...
def download_from_csv(csv_path: str, folder_name: str, scan_type: str = "PET"):
    output = Path(csv_path).parent  / folder_name / scan_type
...
if __name__ == "__main__":
    ...
    download_from_csv(args.csv_file, args.folder_name)
